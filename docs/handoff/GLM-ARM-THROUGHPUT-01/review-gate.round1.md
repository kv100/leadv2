...
suite: plugins/leadv2/scripts/tests/test-glm-lock-per-lane.sh
...
leadv2-suite-falsifiable: suite=/Users/kostiantyn.vlasenko/Projects/leadv2/.claude/worktrees/GLM-ARM-THROUGHPUT-01/plugins/leadv2/scripts/tests/test-glm-lock-per-lane.sh
baseline: rc=0
probe[assertion_tools_broken]: rc=0 shim_invocations=115
probe[empty_cwd]: rc=0
probe[stripped_env]: rc=0
verdict: NOT FALSIFIABLE — /Users/kostiantyn.vlasenko/Projects/leadv2/.claude/worktrees/GLM-ARM-THROUGHPUT-01/plugins/leadv2/scripts/tests/test-glm-lock-per-lane.sh
  exit code 0 under every failure injection (assertion tools broken:
  115 sabotaged-tool call(s); empty working directory; stripped environment).
