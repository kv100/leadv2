Product implementation task dispatch-0672c002. Implement this mechanism-closed design; preserve its non-goals. Before closing, run the required end-to-end gate and the cross-provider review gate recorded for this task.
...
diverge: skipped (lead decision) — the solution space for this lane is fixed by
evidence cited in the brief, not open-ended; widening it would add no options.
===== END SCOPED DESIGN =====
...
question channel and wait for the answer rather than guessing or stalling:
  bash "${CLAUDE_PLUGIN_ROOT}/../../scripts/leadv2-ask.sh" "dispatch-0672c002" "<question>" \
