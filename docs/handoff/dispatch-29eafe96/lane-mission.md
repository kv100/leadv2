# Seamless account switching — design mission
...
Filename: `docs/audits/seamless-account-switching-<yourarm>.md`.

LANE_WRITES: docs/audits/seamless-account-switching-fable.md, docs/audits/seamless-account-switching-astra.md

---
If you hit a decision you cannot safely make yourself (including destructive
options, a policy conflict, or missing authorization), ask via the async
question channel and wait for the answer rather than guessing or stalling:
  bash "${CLAUDE_PLUGIN_ROOT}/../../scripts/leadv2-ask.sh" "dispatch-29eafe96" "<question>" \
