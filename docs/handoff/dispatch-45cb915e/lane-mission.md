LANE PLAN: read /Users/kostiantyn.vlasenko/Projects/leadv2/.claude/worktrees/WORKER-DOD-GATE-01/docs/handoff/WORKER-DOD-GATE-01/context.yaml and the sibling brief.md and plan-*.md before editing.
...
question channel and wait for the answer rather than guessing or stalling:
  bash "${CLAUDE_PLUGIN_ROOT}/../../scripts/leadv2-ask.sh" "dispatch-45cb915e" "<question>" \
