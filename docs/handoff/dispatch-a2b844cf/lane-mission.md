Product implementation task dispatch-a2b844cf. Implement this mechanism-closed design; preserve its non-goals. Before closing, run the required end-to-end gate and the cross-provider review gate recorded for this task.
...
plan authored by the lead 2026-08-31 from live routing logs and quota output; gate 1 taken by the lead.
===== END SCOPED DESIGN =====
...
question channel and wait for the answer rather than guessing or stalling:
  bash "${CLAUDE_PLUGIN_ROOT}/../../scripts/leadv2-ask.sh" "dispatch-a2b844cf" "<question>" \
