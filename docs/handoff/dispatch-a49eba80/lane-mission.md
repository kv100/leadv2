Product implementation task dispatch-a49eba80. Implement this mechanism-closed design; preserve its non-goals. Before closing, run the required end-to-end gate and the cross-provider review gate recorded for this task.
...
plan authored by the lead (persona-engine-d2) 2026-08-31; gate 1 taken by the lead.
See docs/handoff/LEAD-WORKER-CHANNEL-01/brief.md for the full plan.
===== END SCOPED DESIGN =====
...
question channel and wait for the answer rather than guessing or stalling:
  bash "${CLAUDE_PLUGIN_ROOT}/../../scripts/leadv2-ask.sh" "dispatch-a49eba80" "<question>" \
