Product implementation task dispatch-b6cbf3ce. Implement ONLY the scoped design below; preserve its non-goals. Before closing, run the required end-to-end gate and the cross-provider review gate recorded for this task.
...
## Base
Worktree `d4d014e1`, on top of `5ba7620`. Already rebased — do NOT rebase again.
...
question channel and wait for the answer rather than guessing or stalling:
  bash "${CLAUDE_PLUGIN_ROOT}/../../scripts/leadv2-ask.sh" "dispatch-b6cbf3ce" "<question>" \
