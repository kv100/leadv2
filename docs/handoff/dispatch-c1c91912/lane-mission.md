Product implementation task dispatch-c1c91912. Implement ONLY the scoped design below; preserve its non-goals. Before closing, run the required end-to-end gate and the cross-provider review gate recorded for this task.
...
RED-2 "plan-followups-01" = test-plan-followups-01.sh. GREEN on canonical main (21/0,
lead-verified), red only in your lane → a regression from the lane's uncommitted diff.
Root-cause and fix in the lane.
...
question channel and wait for the answer rather than guessing or stalling:
  bash "${CLAUDE_PLUGIN_ROOT}/../../scripts/leadv2-ask.sh" "dispatch-c1c91912" "<question>" \
