...
| `/leadv2 supervise` | **Retired 2026-08-19 (founder order, SUPERVISOR-DELETE-01)** — the standalone supervisor session mode (loop/pick/watchdog daemon) is gone. Reconciliation lives in `scripts/leadv2-lanes-snapshot.sh`; see `.claude/skills/leadv2-supervise/SKILL.md`. |
