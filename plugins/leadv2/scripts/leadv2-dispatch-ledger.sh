...
# ONE-STATUS-MECHANISM-01 (2026-09-13): the lane-pulse-watch reap-on-close
# block and its watch-lifecycle sourcing were deleted with the retired
# lane-pulse-watch chain -- the watcher that wrote those pidfiles no longer
# exists, so there is nothing left to reap.
