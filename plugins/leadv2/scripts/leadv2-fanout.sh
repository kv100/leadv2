...
# leadv2_fanout_register_session (D1-SINGLE-WRITER-FOR-LANE-STATE): it was a
# hand-synced duplicate in two files and had already drifted (the launcher's
# copy predated the log_path_override and writeset args and ran heavy_max
# default 2 vs 3). The registry defines the underscore alias too, so every
