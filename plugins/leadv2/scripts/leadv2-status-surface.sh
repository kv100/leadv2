...
#   S3 supervisor gate      retired (SUPERVISOR-DELETE-01) — SUP_STATE is a
#                           static "off", no file read
...
# ── Supervisor gate — retired (SUPERVISOR-DELETE-01, founder order
# 2026-08-17). No script writes .supervise-active or
# .supervise-loop.heartbeat anymore, so this is permanently "off" — kept as
# static globals rather than a live liveness computation.
SUP_STATE="off"
