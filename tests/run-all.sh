...
# PHASE-REFUSAL-LEAVES-A-LANE-REGISTERED-01: release-on-refusal, duplicate-row
# visibility and process-kind liveness live in these two scripts.
leadv2-dispatch-code.sh:plugins/leadv2/scripts/tests/test-phase-refusal-lane-release.sh
leadv2-active-registry.sh:plugins/leadv2/scripts/tests/test-phase-refusal-lane-release.sh"
